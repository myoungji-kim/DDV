...
<div id="wrap_analyzeList">
	<div class="countTotal"> 퀵폴별 참여 인원 </div>
	<form name="searchAnalyzeForm" method="get" style="display: inline-block;">
		<input type="hidden" name="category" value="poll"> 
		<div class="inputDate">
	...
	<table>
		...
		<tr>
			...
			<td class="title"><a href="/admin/pollAnalyze/detailResult?p_idx=${poll.p_idx}" style="border-bottom: 1px solid #888;">결과보기</a></td>
			<td class="title"><a href="/admin/pollAnalyze/detailPeople?p_idx=${poll.p_idx}" style="border-bottom: 1px solid #888;">${poll.sum}</a></td>
		</tr>
		</c:forEach>
		</tbody>
	</table>
