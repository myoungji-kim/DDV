...
<div id = "wrap_memberList">
	...
	<table>
		<thead>
			<tr>
				...
				<td class="point"> 성별 </td>
				<td class="joinDate"> 가입일 </td>
				<td class="email"> 이메일 주소 </td>
			</tr>
		</thead>
		<tbody>
		<c:forEach var="user" items="${adminList}" varStatus="status">
		<tr>
			<td class="idx"> ${user.m_idx} </td>
			<td class="box_info">
				<a href="/admin/editAdminInfo?m_idx=${user.m_idx}">
			...
			<span> 
				...
				<c:if test="${user.gender == 'W'}"> 여 </c:if> 
			</span>
			</td>
	...
	<a class="ico_create" href = "/admin/editAdminInfo"> <img src = "/img/btn_create_03.png"> </a>
</div>